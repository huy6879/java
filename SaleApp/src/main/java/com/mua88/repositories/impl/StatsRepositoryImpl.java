...
//import com.mua88.pojo.OrderDetail;
//import com.mua88.pojo.Product;
//import com.mua88.pojo.SaleOrder;
...
//    }
//
//    public List<Object[]> statsVenue(Map<String, String> params) throws ParseException {
//        try (Session session = HibernateUtils.getFactory().openSession()) {
//            CriteriaBuilder b = session.getCriteriaBuilder();
//            CriteriaQuery<Object[]> q = b.createQuery(Object[].class);
//            Root rP = q.from(Product.class);
...
//                predicates.add(b.greaterThan(rO.get("createdDate"), FORMAT.parse(fd)));
//            }
//
//            String td = params.get("toDate");
//            if (td != null && !td.isEmpty()) {
//                predicates.add(b.lessThan(rO.get("createdDate"), FORMAT.parse(td)));
//            }
//
